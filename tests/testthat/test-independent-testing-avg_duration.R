...
test_that("if par = NULL, return the average duration in each group (take the r2rtf::r2rtf_adae dataset as an example)", {
  ...
  db <- data.frame(id = r2rtf_adae$USUBJID, group = r2rtf_adae$TRTA, dur = r2rtf_adae$ADURN)
  res <- db |>
    group_by(group) |>
    summarise(
  ...
  avg_dur2 <- avg_duration(r2rtf_adae$USUBJID, r2rtf_adae$TRTA, dur = r2rtf_adae$ADURN)
...
test_that("if, say, par = AEDECOD, return the average duration per group per AE (take the r2rtf::r2rtf_adae dataset as an example)", {
  r2rtf_adae$TRTA <- factor(r2rtf_adae$TRTA)
  db <- data.frame(id = r2rtf_adae$USUBJID, group = r2rtf_adae$TRTA, dur = r2rtf_adae$ADURN, par = r2rtf_adae$AEDECOD)
  ...
  avg_dur2 <- avg_duration(r2rtf_adae$USUBJID, r2rtf_adae$TRTA, dur = r2rtf_adae$ADURN, par = r2rtf_adae$AEDECOD)
  expect_equal(avg_dur1, avg_dur2)
})
