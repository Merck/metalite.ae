...
resource_files:
  - rtf/ae0specific2a.rtf
  - rtf/ae0specific2b.rtf
  - rtf/ae0specific2c.rtf
---
...
same approach used in the [AE Specific Table](ae-specific.html) vignette.
...
```{r download-inference-rtf, results="asis", echo=FALSE}
cat(
  '<p><a href="rtf/ae0specific2a.rtf" download="ae0specific2a.rtf">',
...
```{r download-duration-rtf, results="asis", echo=FALSE}
cat(
  '<p><a href="rtf/ae0specific2b.rtf" download="ae0specific2b.rtf">',
  "Download the generated RTF table</a></p>"
)
```
...
```{r download-events-rtf, results="asis", echo=FALSE}
cat(
  '<p><a href="rtf/ae0specific2c.rtf" download="ae0specific2c.rtf">',
  "Download the generated RTF table</a></p>"
)
```
