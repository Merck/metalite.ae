...
There are three steps to create AE summary analysis table using metalite.ae:
...
With the three function we can quickly create an AE summary analysis as shown in 
