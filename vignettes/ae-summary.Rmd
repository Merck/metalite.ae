...
The purpose of this tutorial is to create product ready AE summary analyses 
...
there are three required steps to create AE summary analysis table using metalite.ae:
